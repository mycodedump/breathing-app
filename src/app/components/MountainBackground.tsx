...
export function MountainBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <style>{`
        @keyframes sway1 { 0%, 100% { transform: translateX(0); } 25% { transform: translateX(4px); } 75% { transform: translateX(-4px); } }
        @keyframes sway2 { 0%, 100% { transform: translateX(0); } 30% { transform: translateX(-6px); } 70% { transform: translateX(6px); } }
        @keyframes sway3 { 0%, 100% { transform: translateX(0); } 35% { transform: translateX(7px); } 65% { transform: translateX(-7px); } }
        @keyframes sway4 { 0%, 100% { transform: translateX(0); } 40% { transform: translateX(-9px); } 60% { transform: translateX(9px); } }
      `}</style>

      {/* Shift the whole mountain assembly down slightly */}
      <div className="absolute inset-0" style={{ transform: "translateY(4%)" }}>
        ...
        <div
          ...
          style={{ zIndex: 2, animation: "sway1 40s ease-in-out infinite" }}
        >
        ...
        <div
          ...
          style={{ zIndex: 3, animation: "sway2 32s ease-in-out infinite" }}
        >
        ...
        <div
          ...
          style={{ zIndex: 4, animation: "sway3 26s ease-in-out infinite" }}
        >
        ...
        <div
          ...
          style={{ zIndex: 5, animation: "sway4 20s ease-in-out infinite" }}
        >
